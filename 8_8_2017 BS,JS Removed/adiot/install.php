...
<div id ="sidebar" class="sidebar-nav panel panel-default toggled">
	...
	$('#edit').click( function(){
		...
		$.post( "editinst.php" , obj, function(info){ $("#resulted").html(info); });
		$('#EditForm').modal('hide');
		location.reload();
	...
	$('#remove').click( function(){
		...
		$.post( "deleteinst.php" , obj, function(info){ $("#resulted").html(info); });
		$('#EditForm').modal('hide');
		location.reload();
    ...
    $('#next').click( function() {
		...
		$.post( "addinst.php" , obj, function(info){ $("#result").html(info); });
	    $('#add_qta').val("");
